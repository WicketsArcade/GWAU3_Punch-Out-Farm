            ...
            For $i = 1 To 8
                ...
                If Brawling_IsRecharged($i) Then
                    ...
                    If $iAdrenaline >= $iCost Then
                        ...
                        Else
                            Brawling_LogCombat("Failed to use Skill " & $i & " on Target " & Agent_GetAgentInfo($target, 'ID'))
                        EndIf
                    Else
                        ; Brawling_LogCombat("Skipping Skill " & $i & " - Not enough Adrenaline (" & $iAdrenaline & "/" & $iCost & ")")
                    EndIf
                EndIf
            Next
        EndIf
